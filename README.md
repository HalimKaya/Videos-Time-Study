...
python main.py
2.	Open a video file.
3.	Mark specific points using the input field and 'Point' button.
4.	Save annotations with the 'Save' button.
5.	View the generated pie chart within the application.
Automation
This project is integrated with a batch file **(start.bat)** for easy execution.
